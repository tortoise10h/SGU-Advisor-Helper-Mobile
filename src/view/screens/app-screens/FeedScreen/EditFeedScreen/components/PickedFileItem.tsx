...
const PickedFileItem = ({
  ...
  const getDisplayFileName = () => {
    ...
    let displayFileName = fileNameParams[fileNameParams.length - 1];
    console.log('[getDisplayFileName] displayFileName: ', displayFileName);
    if (displayFileName.length > 30) {
      displayFileName = `${displayFileName.slice(0,  25)}...${getFileExtension(file.name)}`;
    }
